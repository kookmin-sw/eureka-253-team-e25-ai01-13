...
또한 **컴퓨터 속 세계와 물리적 현실을 연결하기 위한 시도**이기도 했다.  

2️⃣ **What**  
**신체의 움직임을 통해 전자기기에서 가능한 활동을 수행할 수 있는 장치**,  
즉 **제스처 기반의 물리적 상호작용 시스템**이다.  

3️⃣ **How**  
**신체의 움직임을 입력으로 인식**하고,  
**프로젝터나 빔을 통해 벽면·종이 등의 표면에 정보를 투사**하여  
상호작용이 가능하도록 한다.  
**카메라와 마이크로 제스처를 인식하고, 빔 프로젝터로 결과를 시각화**한다.
...
| 구분 | 내용 |
|------|------|
| **Why** | 현실과 디지털 세계의 경계를 허물고 자연스러운 정보 활용을 가능하게 하기 위해 |
| **What** | 제스처와 웨어러블 기술을 이용해 현실에서 디지털 정보를 조작할 수 있는 장치 |
| **How** | 카메라·프로젝터·마이크를 이용해 제스처를 인식하고, 현실 공간 위에 정보를 투영 |
...
> 이는 **웨어러블 기기(예: 갤럭시 워치)** 시대의 시초라 할 수 있다.  
...
| 구분 | As-Is (기존) | To-Be (Sixth Sense 이후) |
|------|---------------|---------------------------|
| **입력 방식** | 키보드, 마우스 등 물리 장치 | 손동작, 제스처, 신체 인식 |
| **출력 방식** | 모니터, 고정형 화면 | 프로젝션, 현실 표면에 투영 |
| **사용 환경** | 책상 위 정적인 공간 | 언제 어디서나 사용 가능한 **웨어러블·AR 환경** |
